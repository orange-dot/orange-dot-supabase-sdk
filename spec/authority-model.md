...
The orchestration layer keeps a strict distinction between components that request, components that decide, components that project, and components that observe.
